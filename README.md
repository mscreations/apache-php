...
This is an Apache image that includes SSL and PHP5 support. It also includes specific support for creating images (GD, ImageMagick) as well as having XDebug support.
...
Original Author Ed Boraas <ed@boraas.ca>
